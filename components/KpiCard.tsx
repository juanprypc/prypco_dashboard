...
export function KpiCard({ title, value, unit, note }: Props) {
  ...
  return (
    <div className="flex h-full w-full flex-col items-start justify-between rounded-[22px] bg-[var(--color-panel-soft)] p-3 text-left text-[var(--color-outer-space)] sm:rounded-[28px] sm:p-6">
