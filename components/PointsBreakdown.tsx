  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 xl:grid-cols-3 xl:gap-5 xl:justify-items-center">
      {items.map((item) => (
        <div
          key={item.key}
          className="flex w-full flex-col rounded-[26px] border border-[#d1b7fb] bg-[var(--color-panel-soft)] p-4 text-[var(--color-outer-space)] shadow-[0_25px_60px_-45px_rgba(13,9,59,0.35)] sm:h-full sm:min-h-[200px] sm:justify-between sm:p-6 xl:max-w-[280px]"
        >
